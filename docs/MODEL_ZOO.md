...
The six final checkpoints are available in the public `v3.1-review` GitHub
Release. Large data and per-image result files remain separate:

| Asset | Status | Planned storage |
|---|---|---|
| 3-RCAB seed 42 final weights | available | `v3.1-review` Release asset |
| 3-RCAB seed 43 final weights | available | `v3.1-review` Release asset |
| 3-RCAB seed 44 final weights | available | `v3.1-review` Release asset |
| Matched no-RFDPL final weights | available | `v3.1-review` Release asset |
| 1,024-pair SIDD+ validation bundle | available under upstream research/education notice | `v3.1-review` Release asset |
